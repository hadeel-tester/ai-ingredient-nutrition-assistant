...
This is the project for Sprint 2, where you bring together LangChain, RAG, function calling, and vector databases to build a specialized, domain-focused chatbot. Unlike the Sprint 1 project, this one requires advanced RAG with query translation, tool calling for practical tasks, and a polished user interface. The result should be something that provides real value in a specific domain, and the architectural patterns you use here will carry directly into Sprint 3's autonomous agents.
